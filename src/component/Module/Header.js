...
export class HeaderForm extends Component {
        ...
        OnloadData() {
            ...
            if (textinput.search === '' || textinput.search.length === 0 || textinput.search === null) {
                ...
                let items = fetchapi('car/get_car/', { search: textinput.search })
            ...
            if (data) {
                load = (
                    <Grid columns={2} stackable>
                        ...
                        <Grid.Row columns={3}>
                            <Grid.Column>
                                <Segment color="black">Division : {data.user_department} </Segment>
                            </Grid.Column>
                            <Grid.Column>
                                <Segment color="black">Department : {data.user_department} </Segment>
                            </Grid.Column>
                            <Grid.Column>
                                <Segment color="black">
                        ...
                        <Grid.Row columns={2}>
                            ...
                            <Grid.Column>
                                <Segment color="black">Oil Type : {data.product} </Segment>
                            </Grid.Column>
                        </Grid.Row>
                    </Grid>
                )
